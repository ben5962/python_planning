...
class testbdd(unittest.TestCase):
    ...
    def test_python_version(self):
        import sys
        truth = sys.version_info[0] == 3
        self.assertTrue(truth, "python doit etre > 3!")
    

    def test_cnx_db(self):
        import db
        import sqlite3
        
        silentremove('essai.db')
        
        d = db.realdb(fichdb='essai.db')
        d.getCnx()
        d.fermerCnx()
        self.assertTrue(d.TestFichierDbExiste())

    def test_get_nom_ficher_db(self):
        import db
        import sqlite3
        nom_fichier = 'pouet.db'
        silentremove(nom_fichier)
        
        d = db.realdb(fichdb=nom_fichier)
        d.getCnx()
        d.fermerCnx()
        self.assertEqual(d.getFichierDb(), nom_fichier)
