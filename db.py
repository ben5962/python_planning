...
import pkg_date_heure.math_date
from pkg_date_heure.math_date import Date as dt
...
class realdb (object):
    ...
    def setBibliothecaireDba(self):
        ...
        from pkg_bibliothecaire_dba.bibliothecaire_dba import bibliothecaire_dba
...
leurs contraintes"""
        ...
        ListeTables = self.getCnx().execute(self.getBibliothecaireDba()
                                .getRequeteMetaByName('non_vide_si_table_planning_existe')
                                ).fetchall()
    ...
    def getCnx (self):
        ...
        EAFP way"""
        self.setCnx()
        """ ici creation des fonctions utilisables dans sqlite"""
        import pkg_date_heure.math_date
        from pkg_date_heure.math_date import isoweek
        self.cnx.create_function('isoweek',1,isoweek)
        return self.cnx
